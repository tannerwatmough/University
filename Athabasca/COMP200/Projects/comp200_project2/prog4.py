...
# This allows the 'extra credit' function of clearing the terminal to work on both Windows and Unix (Linux and Mac) based systems since I cannot be 100% certain if you, the tutor, is using Unix or Windows to review this project.
