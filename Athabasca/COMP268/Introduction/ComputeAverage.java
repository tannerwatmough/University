 ...
 * and to enter a 0 to mark the end of the data. (The zero is
 * not counted as part of the data to be averaged). The program
 * does not check whether the user's input is positive, so it
 * will actually add up both positive and negative input values.
 */
public class ComputeAverage {

    public static void main(String[] args) {
        int inputNumber; // One of the integers input by the user.
        int sum; // Sum of positive integers
