...
public class Transactions {
  // Create some bank accoutns and requests various services.
  public static void main(String[] args) {
    ...
    System.out.println("Adams balance after withdrawal: " +
        acct2.withdraw(480.00, 1.50));

    acct3.withdraw(-100.00, 1.50); // Invalid transation

    acct1.withdraw(100, 1.50); // Insufficient funds
